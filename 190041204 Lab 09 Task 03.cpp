...
//    dis(2);
    ...
    f_list[0] =  new Bed ("Fur#101",3000,15,Material::Foam,BedSize::SemiDouble);
    f_list[1] =  new Sofa ("Sofa#131",10000,100,Material::Steel,1);
    f_list[2] =  new DiningTable ("Dining_Table#1023",1100,50,Material::Board,2);
